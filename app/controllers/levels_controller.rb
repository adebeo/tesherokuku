class LevelsController < ApplicationController
  ...
  # POST /levels.json
  def create
    @level = @program.levels.new(level_params)

    respond_to do |format|
      if @level.save
        format.html { redirect_to [@program,@level], notice: 'Level was successfully created.' }
  ...
  private
    ...
    def level_params
      params.require(:level).permit(:name, :description, :order, :program_id)
    end
end
