...
class LevelsControllerTest < ActionController::TestCase
  ...
  test "should create level" do
    assert_difference('Level.count') do
      post :create, level: { description: @level.description, name: @level.name, order: @level.order, program_id: @level.program_id }
    end
  ...
  test "should update level" do
    patch :update, id: @level, level: { description: @level.description, name: @level.name, order: @level.order, program_id: @level.program_id }
    assert_redirected_to level_path(assigns(:level))
  end
